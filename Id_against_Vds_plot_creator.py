...
plt.plot (plotu[0], plotu[1],'--', label='0.6V Unified')
plt.plot (plotu[0], plotu[2],'--', label='0.9V Unified')
plt.plot (plotu[0], plotu[3],'--', label='1.2V Unified')
plt.plot (plotu[0], plotu[4],'--', label='1.5V Unified')
plt.plot (plotu[0], plotu[5],'--', label='1.8V Unified')
